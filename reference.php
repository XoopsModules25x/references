 ...
 */
require 'header.php';
$xoopsOption['template_main'] = 'references_reference.html';
require XOOPS_ROOT_PATH . '/header.php';

$baseurl = REFERENCES_URL . basename(__FILE__);
$artice_id = isset($_GET['article_id']) ? intval($_GET['article_id']) : 0;
if ($artice_id == 0) {
...
// Breadcrumb
$breadcrumb = array($category->getUrl() => $category->getVar('category_title'),
